...
public class CrystallizerMenu extends AbstractContainerMenu {
    public final net.majleeuwerik.semiconcraft.block.entity.custom.CrystallizerBlockEntity blockEntity;
    ...
    public CrystallizerMenu(int pContainerId, Inventory inv, BlockEntity entity, ItemStacksResourceHandler handler, ContainerData data) {
        super(SCMenuTypes.CRYSTALLIZER_MENU.get(), pContainerId);

        blockEntity = ((net.majleeuwerik.semiconcraft.block.entity.custom.CrystallizerBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, SCBlocks.CRYSTALLIZER.get());
    }
