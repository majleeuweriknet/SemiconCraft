...
public class SCBlockLootTableProvider extends BlockLootSubProvider {
    public SCBlockLootTableProvider(HolderLookup.Provider registries) {
    ...
    protected Iterable<Block> getKnownBlocks() {
        return SCBlocks.BLOCKS.getEntries().stream().map(Holder::value)::iterator;
    }
}
